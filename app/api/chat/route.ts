...
export async function POST(req: Request) {
    try {
        ...
        const messagesWithSystem = [
            {
                role: "system",
                content: "You are administering a CMSC131 exam. Ask questions one at a time about the exam and the topics covered in the course. dont say if a user is correct or not. the exam will be graded later." +
